 ...
 public:
  ...
  void counter1(int TIME) {
    ...
    if (head->ordertime == 0) {
      ...
      dequeue();
      cout << "Customer removed from counter 1" << endl;
      return;
    }
  ...
  void counter2(int TIME) {
    ...
    if (head->next->ordertime == 0) {
      ...
      dequeue2();
      cout << "Customer removed from counter 2" << endl;
      return;
    }
    head->next->ordertime = (head->next->ordertime - 1);
